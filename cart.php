...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <a href="view_page.php?pid=<?php echo $fetch_cart['pid']; ?>&type=<?php echo  $fetch_cart['product_type'] == 'seeds'? 'seeds' : 'plants'; ?>" class="fas fa-eye"></a>
        <img src="uploaded_img/<?php echo $fetch_cart['image']; ?>" alt="" class="image">
        <div class="name"><?php echo $fetch_cart['name']; ?></div>
        <div class="price">Rs. <?php echo $fetch_cart['price']; ?>/- <?php echo  $fetch_cart['product_type'] == 'seeds'? 'Per KG' : 'Per Plant'; ?>
        </div>
